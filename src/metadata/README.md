 ...
 * [testeo.yml](testeo.yml)
     * Determines how your purl.obolibrary.org/obo/testeo/ redirects will be handled
     ...
     * Paste in the contents of [testeo.yml](testeo.yml)
 ...
 * [testeo.md](testeo.md)
     ...
     * Paste in the contents of [testeo.md](testeo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
